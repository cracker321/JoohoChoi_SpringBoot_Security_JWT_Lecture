...
//- 스프링 시큐리티에서 제공하는 내장 인터페이스로, '사용자 정보를 가져오는 역할'을 함.
...
public class PrincipalDetailsService implements UserDetailsService {
    ...
    //- '스프링 시큐리티 내장 인터페이스 UserDetailService'를 구현하려면, 반드시 오버라이딩해야 하는 메소드임.
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        //순서 2)-1 사용자 정보 확인: db로부터 가져온 사용자 정보가 null이 아닌 경우
        //- null이 아닌 경우, 'PrincipalDetails 객체'를 '생성'하여 '반환'함.
        //
        if(userEntity != null){
